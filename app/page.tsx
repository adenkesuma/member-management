    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="text-sm text-gray-600">
          ...
          anggota tersebar di{" "}
          <span className="font-bold text-primary">{stats.totalBranches}</span>{" "}
          cabang
        </div>
      </div>
            ...
            {branchesWithCounts.map((branch) => (
              ...
              >
                <div className="relative">
                  ...
                  ></div>
                  {branch.members > 0 && (
                    <div className="absolute -top-1 -right-1 w-4 h-4 bg-primary text-white rounded-full text-xs flex items-center justify-center">
                      {branch.members}
                    </div>
                  )}
                </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-gray-50 border p-4 rounded-2xl">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm text-primary">Cabang Terbanyak</div>
          ...
          <div className="bg-gray-50 border p-4 rounded-2xl">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm text-primary">Total Cabang</div>
          ...
          <div className="bg-gray-50 border p-4 rounded-2xl">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm text-primary">Rata-rata Anggota</div>
                <div className="text-xl font-bold text-blue-900">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              <div className="flex items-center gap-4">
                ...
                <span className="py-1 text-yellow-400 px-4 rounded-xl border border-yellow-400 text-xs">
                  Official Website
                </span>
              </div>
              <Image src={PDSKKILogo} alt="PDSKKI Logo" className="w-18" />
            </div>
          </div>
        </div>
      </header>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t">
                ...
                <Select>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="family-doctor">
                      Dokter Keluarga
                    </SelectItem>
                ...
                <Select>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="year-asc">
                      Tahun Bergabung (Lama)
                    </SelectItem>
                    <SelectItem value="year-desc">
                      Tahun Bergabung (Baru)
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-gray-600 text-sm">
                ...
                {statusFilter &&
                  ` • Status: ${statusFilter === "active" ? "Aktif" : statusFilter === "inactive" ? "Nonaktif" : "Dalam Proses"}`}
                  ...
                  <div className="flex gap-2">
                    {[1, 2, 3].map((page) => (
                      <Button
                        ...
                        variant="outline"
                        className={
                          page === 1 ? "bg-blue-50 border-blue-200" : ""
                        }
                      >
                        {page}
                      </Button>
