...
export default function AllPaymentHistory({
  ...
  const allPayments: Payment[] = useMemo(
    () => [
      ...
      {
        id: 10,
        invoice: "INV-2022-010",
        date: "15 Sep 2022",
        amount: 575000,
        method: "Transfer Bank",
        status: "success",
        description: "Iuran Q3 2022",
        category: "Kuartal",
        year: "2022",
      },
      {
        id: 11,
        invoice: "INV-2022-009",
        date: "15 Jun 2022",
        amount: 575000,
        method: "Virtual Account",
        status: "success",
        description: "Iuran Q2 2022",
        category: "Kuartal",
        year: "2022",
      },
      {
        id: 12,
        invoice: "INV-2022-008",
        date: "15 Mar 2022",
        amount: 575000,
        method: "Transfer Bank",
        status: "success",
        description: "Iuran Q1 2022",
        category: "Kuartal",
        year: "2022",
      },
      ...
      {
        id: 14,
        invoice: "INV-2021-009",
        date: "15 Sep 2021",
        amount: 575000,
        method: "Virtual Account",
        status: "success",
        description: "Iuran Q3 2021",
        category: "Kuartal",
        year: "2021",
      },
      {
        id: 15,
        invoice: "INV-2021-008",
        date: "15 Jun 2021",
        amount: 575000,
        method: "Credit Card",
        status: "success",
        description: "Iuran Q2 2021",
        category: "Kuartal",
        year: "2021",
      },
      {
        id: 16,
        invoice: "INV-2021-007",
        date: "15 Mar 2021",
        amount: 575000,
        method: "Transfer Bank",
        status: "success",
        description: "Iuran Q1 2021",
        category: "Kuartal",
        year: "2021",
      },
      ...
      {
        id: 18,
        invoice: "INV-2020-008",
        date: "15 Sep 2020",
        amount: 525000,
        method: "Transfer Bank",
        status: "success",
        description: "Iuran Q3 2020",
        category: "Kuartal",
        year: "2020",
      },
      {
        id: 19,
        invoice: "INV-2020-007",
        date: "15 Jun 2020",
        amount: 525000,
        method: "Credit Card",
        status: "success",
        description: "Iuran Q2 2020",
        category: "Kuartal",
        year: "2020",
      },
      {
        id: 20,
        invoice: "INV-2020-006",
        date: "15 Mar 2020",
        amount: 525000,
        method: "Virtual Account",
        status: "success",
        description: "Iuran Q1 2020",
        category: "Kuartal",
        year: "2020",
      },
      ...
      {
        id: 21,
        invoice: "INV-2019-008",
        date: "10 Dec 2019",
        amount: 2000000,
        method: "Transfer Bank",
        status: "success",
        description: "Iuran Tahunan 2019",
        category: "Tahunan",
        year: "2019",
      },
      {
        id: 22,
        invoice: "INV-2019-007",
        date: "15 Sep 2019",
        amount: 500000,
        method: "Virtual Account",
        status: "success",
        description: "Iuran Q3 2019",
        category: "Kuartal",
        year: "2019",
      },
      {
        id: 23,
        invoice: "INV-2019-006",
        date: "15 Jun 2019",
        amount: 500000,
        method: "Transfer Bank",
        status: "success",
        description: "Iuran Q2 2019",
        category: "Kuartal",
        year: "2019",
      },
      {
        id: 24,
        invoice: "INV-2019-005",
        date: "15 Mar 2019",
        amount: 500000,
        method: "Credit Card",
        status: "success",
        description: "Iuran Q1 2019",
        category: "Kuartal",
        year: "2019",
      },
    ],
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center mb-2">
          <p className="text-sm text-gray-600">
            ...
            {filters.status &&
              ` dengan status ${getStatusText(filters.status)}`}
          </p>
              ...
              {currentPayments.length > 0 ? (
                currentPayments.map((payment) => (
                  <tr key={payment.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4">
                      <span className="px-2 py-1 bg-blue-50 text-primary text-xs rounded-full">
                        {payment.category}
                      </span>
                    </td>
                    <td className="py-3 px-4">
                ...
                <tr>
                  <td colSpan={7} className="py-8 text-center text-gray-500">
                    Tidak ada transaksi yang ditemukan dengan filter yang
                    dipilih
                  </td>
                </tr>
              )}
